...
public class CricketLeagueAnalyserTest {
    ...
    CricketLeagueAnalyser cricketAnalyser = null;
    ExpectedException expectedException = null;

    @Before
    public void setUp() {
        cricketAnalyser = new CricketLeagueAnalyser();
    ...
    public void givenIPLFactSheetMostRunsFile_whenSortedOnBattingAverage_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.AVERAGE_OF_BATSMAN);
    ...
    public void givenIPLFactSheetMostRunsFile_whenSortedOnStrikingRateOfBatsman_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.BATTING_STRIKE_RATE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostRunsFile_whenSortedOn6sAnd4s_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
            cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
            String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.SIX_AND_FOURS);
            IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostRunsFile_whenSortedOnStrikingRateAnd6sAnd4s_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.SIX_AND_FOURS_WITH_STRIKE_RATE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("Ishant Sharma", cricketCSV[0].player);
    }
    ...
    public void givenIPLFactSheetMostRunsFile_whenSortedOnBattingAveragesAndBestStrikingRate_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.AVERAGE_WITH_BEST_STRIKE_RATE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("MS Dhoni", cricketCSV[0].player);
    }
    ...
    public void givenIPLFactSheetMostRunsFile_whenSortedOnMaximumRunsAndBestAverages_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.MAXIMUM_RUNS_WITH_BEST_AVERAGES);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostwktsFile_whenSortedOnBowlingAverage_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOWLER, CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.AVERAGE_OF_BOWLING);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostWktsFile_whenSortedOnStrikingRateOfBowlers_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOWLER, CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.BOWLING_STRIKE_RATE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("Krishnappa Gowtham", cricketCSV[0].player);
    }
    ...
    public void givenIPLFactSheetMostWktsFile_whenSortedOnEconomyRate_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOWLER, CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.ECONOMY_RATE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostWktsFile_whenSortedOnvStrikingRateAnd5And4Wickets_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
            cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOWLER, CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
            String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.BEST_STRIKING_RATE_WITH_4AND5WICKET);
            IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostWktsFile_whenSortedOnBowlingAveragesAndBestStrikingRate_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOWLER, CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.BOWLING_AVERAGE_WITH_STRIKE_RATE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("Krishnappa Gowtham", cricketCSV[0].player);
    }
    ...
    public void givenIPLFactSheetMostWktsFile_whenSortedOnMaximumWicketsAndBowlingAverages_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOWLER, CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.MAXIMUM_WICKET_WITH_BEST_BOWLING_AVERAGE);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
    ...
    public void givenIPLFactSheetMostWktsAndIPLFactSheetMostRunsFiles_whenSortedOnBattingAndBowlingAverages_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOTH,CRICKET_LEAGUE_RUNS_CSV_FILE_PATH,CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOTH, SortByField.Field.BEST_AVERAGES_OF_BOTH);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("MS Dhoni", cricketCSV[0].player);
    }
    ...
    public void givenIPLFactSheetMostWktsAndIPLFactSheetMostRunsFiles_whenSortedOnMostRunsAndWickets_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BOTH,CRICKET_LEAGUE_RUNS_CSV_FILE_PATH,CRICKET_LEAGUE_WICKETS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BOWLER, SortByField.Field.ALL_ROUNDER);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("David Warner", cricketCSV[0].player);
    }
    @Test
    public void givenIPLFactSheetMostRunsFile_whenSortedOnBestBattingAverageWithMax100_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.MAXIMUM_HUNDREDS_WITH_BEST_AVERAGES);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
        Assert.assertEquals("David Warner", cricketCSV[0].player);
    }

    @Test
    public void givenIPLFactSheetMostRunsFile_whenSortedOnBestBattingAverageWithNo50And100_shouldReturnSortedResult() throws CricketLeagueAnalyserException {
        cricketAnalyser.loadIPLFactSheetData(CricketLeagueAnalyser.PlayerType.BATSMAN, CRICKET_LEAGUE_RUNS_CSV_FILE_PATH);
        String playerWiseSortedData = cricketAnalyser.getFieldWiseSortedPlayersData(CricketLeagueAnalyser.PlayerType.BATSMAN, SortByField.Field.BEST_AVERAGES_WITH_ZERO_FIFTIES_AND_HUNDREDS);
        IPLMostRunsCSV[] cricketCSV = new Gson().fromJson(playerWiseSortedData, IPLMostRunsCSV[].class);
